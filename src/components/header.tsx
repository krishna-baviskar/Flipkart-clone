...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-primary text-primary-foreground shadow-md">
      <div className="container flex h-16 items-center justify-between gap-4 px-4 md:h-20 md:gap-8">
        <div className="flex items-center gap-2">
          <Link href="/" className="flex flex-col items-center space-x-2">
            <Logo />
          </Link>
        </div>
        <div className="flex-1 relative hidden sm:block max-w-xl">
        ...
        <div className="flex items-center justify-end space-x-2">
          <nav className="flex items-center gap-1 sm:gap-2">
            {!isMobile && (
              <>
                <Button variant="ghost" asChild className="hidden lg:flex text-base font-medium hover:bg-primary/90 rounded-lg px-4 py-2">
                    <Link href="#">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="hidden md:flex text-base font-medium hover:bg-primary/90 rounded-lg px-4 py-2">
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent>
                  {isMobile && (
                    <>
                       <DropdownMenuItem asChild><Link href="/login"><User className="mr-2 h-4 w-4" />Sign In</Link></DropdownMenuItem>
      ...
      <div className="sm:hidden bg-primary px-4 pb-2">
